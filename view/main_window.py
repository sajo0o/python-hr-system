...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.sb_depts = QtWidgets.QComboBox(Form)
        self.sb_depts.setMaximumSize(QtCore.QSize(200, 16777215))
        self.sb_depts.setObjectName("sb_depts")
        self.sb_depts.addItem("")
        self.verticalLayout.addWidget(self.sb_depts)
    ...
    def retranslateUi(self, Form):
        ...
        self.sb_depts.setItemText(0, _translate("Form", "Select department"))
        ...
        self.pushButton_5.setText(_translate("Form", "Export"))
